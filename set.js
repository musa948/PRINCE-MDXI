...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~uF5jvoh9bewiBv7Wi2ds", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
STATUS_REPLY_MSG: process.env.STATUS_REPLY_MSG || "✅️ Status Viewed by Musa", // // Input Yours custom...
MODE: process.env.MODE || "public", // Put private or public or inbox or groups
OWNER_NUMBER: process.env.OWNER_NUMBER || "256784079946", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "Musa", // Input Yours custom...(Maintain font for Flow)
